...
The DES-OPF class has two functions:
    1. OPF - for balanced AC OPF
    2. DCOPF - for linear DC approximations
    
Only DCOPF is used in the main under Discrete-DES-MOPF.
